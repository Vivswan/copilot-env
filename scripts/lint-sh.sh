...
shellcheck --severity=warning install.sh shell/agents.bashrc shell/agents.launchers.bashrc bin/agent scripts/setup-env.sh .github/scripts/lifecycle-smoke.sh
echo "shellcheck: OK"
