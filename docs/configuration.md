...
| Key              | Default                       | Effect                                                                                                                                                                                                                                        |
| ---------------- | ----------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `copilot-host`   | `auto`                        | The Copilot API host every mode uses (Direct configs, Claude Desktop, the proxy, every probe): `auto` probes per credential (a proxy with no stored credential is not pinned), or an `https://` origin (a GitHub Enterprise Server host, say) |
