 ...
 *  it since, and a farm under a retired `codex-home` root stays recorded until the next build
 *  (src/codex/host.ts). Only a path still carrying our managed config.toml is deleted. */
