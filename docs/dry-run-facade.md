...
Every module under `src/` reads and writes files through `import * as fs from "../utils/fs_facade.ts"`.

| Call                                                         | What it does                                                                                                                                                                                                               |
| ------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `fs.dryRunActive()`                                          | true inside `withDryRun` (`src/utils/dry_run.ts`)                                                                                                                                                                          |
...
| `fs.entryAbsent(p)`                                          | the same absence test alone                                                                                                                                                                                                |
...
| `fs.openReadable(p)` / `fs.openReadFd(p)` / `fs.closeFd(fd)` | a read handle (`Promise<Deno.FsFile>` / a node fd): the disk's in every mode (a release binary the updater hashes, the daemon's `/dev/null` stdin)                                                                         |
