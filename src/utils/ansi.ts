...
/** Whether the helpers below emit escapes at all (the one NO_COLOR/TERM/CI/TEST decision),
 *  for renderers that build padded layouts and must know whether widths include escapes. */
